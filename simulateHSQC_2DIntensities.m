function [Z] = simulateHSQC_2DIntensities(HCdata, ppm1, ppm2)

%HCdata     table of 1H and 13C chemical shifts for a STD and intensities
...
for i = 1:length(HCdata);
    ...
    A = HCdata(i,3); %intensity

    x0 = HCdata(i,1); y0 = HCdata(i,2);
    sigma_x = 0.01; sigma_y = 0.02; %width
